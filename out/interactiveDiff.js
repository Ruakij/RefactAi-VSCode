...
exports.hands_off_dont_remove_anything = exports.query_the_same_thing_again = exports.like_and_accept = exports.dislike_and_rollback = exports.present_diff_to_user = exports.animation_start = exports.query_diff = exports.on_cursor_moved = void 0;
...
async function query_diff(editor, sensitive_area, model_function, model_force, third_party) {
    ...
    request.supply_stream(...fetchAPI.fetch_api_promise(cancelToken, "query_diff" + ":" + model_function, // scope
    sources, estate.global_intent, model_function, file_name, cursor0, cursor1, max_tokens, max_edits, stop_tokens, stream, model_force, third_party));
}
exports.query_diff = query_diff;
...
async function query_the_same_thing_again(editor) {
...
exports.query_the_same_thing_again = query_the_same_thing_again;
