...
exports.inference_login = exports.inference_login_force_retry = exports.login = exports.secret_api_key = exports.check_if_login_worked = exports.account_message = exports.welcome_message = exports.login_message = void 0;
...
function check_if_login_worked() {
...
exports.check_if_login_worked = check_if_login_worked;
...
async function login() {
    ...
    try {
        ...
        if (json.retcode === "OK") {
            ...
            global.streamlined_login_ticket = "";
            global.longthink_functions_today = json['longthink-functions-today-v2'] || null;
...
function inference_login_force_retry() {
    _last_inference_login_ts = 0;
}
exports.inference_login_force_retry = inference_login_force_retry;
async function inference_login() {
    ...
    if (_last_inference_login_ts + 300 * 1000 > Date.now() &&
...
exports.inference_login = inference_login;
